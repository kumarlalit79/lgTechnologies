...
const NewsLatterBox = () => {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    emailjs
      .sendForm(
        "service_r4xgbdv", // 🔹 Same service ID
        "template_rpcmeqi", // 🔹 Same template ID (bas template me {{name}} aur {{email}} rakhna)
        form.current,
        "5A2awJFIs6lkK4UDQ" // 🔹 Your public key
      )
      .then(
        () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Stay connected with us for the latest projects, insights, and updates.
      </p>
