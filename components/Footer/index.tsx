              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  ...
                  <Image
                    ...
                    height={150}
                    unoptimized
                    className="hidden h-[80px] w-[80px] dark:block"
                  /> */}
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  We build custom software solutions to help businesses grow
                  smarter and faster.
                </p>
                <div className="flex items-center">
                  ...
                  <a
                    href="mailto:lg.technologies.team@gmail.com"
                    aria-label="email"
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">
                      lg.technologies.team@gmail.com
                    </span>
                  </a>
